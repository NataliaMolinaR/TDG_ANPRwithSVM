...
\textbf{Dedico el éxito de este trabajo de grado principalmente a mí}. Este trabajo no solo me permitió contribuir al campo de investigación siendo un gran honor, sino que me dejó un invaluable crecimiento personal y profesional.

A mi Padre \textbf{Jaime Molina}, cuyo sueño fue verme pisar la gran aula magna de la UCV, aunque no podré por fuerzas ajenas a nuestra voluntad, entrego todo el amor y éxito que este trabajo representó a tu sueño. Gracias infinitamente  por toda la sabiduría que  me entregaste.
 
A mi hermano \textbf{Ricardo Molina}, quien siempre me motivó y creyó en mis capacidades para alcanzar grandes metas.
...
%\backmatter
%==================================================================
\chapter{Código del programa Segmentación de caracteres}\label{CAP:anexo2}
%\markboth{Tu anexo}{Tu anexo}%
\input{apendice2.tex}%

%==================================================================
\chapter{Código del entrenamiento del modelo}\label{CAP:anexo4}
%\markboth{Tu anexo}{Tu anexo}%
\input{apendice4.tex}%
