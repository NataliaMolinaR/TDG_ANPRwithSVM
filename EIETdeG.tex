...
\noindent
\textbf{Palabras Claves:} Procesamiento de imagenes, Máquina de soporte Vectorial, SVM, detección, reconocimiento. \\[1ex]

\noindent \textbf{Resumen.-} La presente investigación propone el diseño de un sistema de Reconocimiento Automático de Matrícula vehícular mediante un programa que integra dos módulos con la capacidad de localizar y reconocer la matrícula vehícular en un ambiente con condiciones controladas. El diseño se basó en el procesamiento de imágenes y la Máquina de Soporte Vectorial,  empleando herramientas optimizadas provistas por bibliotecas de código abierto como OpenCV  y Sklearn. Entre las principales técnicas de procesamiento de imágenes empleadas se tiene la Umbralización adaptativa de OpenCV que permitió al sistema detectar la matrícula y los caracteres en ella. El sistema es capaz de reconocer las matrículas con  tasa de éxito mayor al 90\% en las diferentes pruebas obtenidas, con un ajuste lineal del modelo generado por la SVM y una base de datos de apenas 1496. Los tiempos de reconocimiento en promedio se obtuvo 0.26s mientras que el sistema completo, por su parte, 0.88s. 
