...
\end{table}
  ...
  Otro aspecto crucial en la investigación es el tiempo de entrenamiento de la SVM el cual fue de 1.29 para la base de datos construída y las carcterísticas descritas del computador. 
