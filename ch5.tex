...
A continuación se presenta la Tabla \ref{Tab:prueba1}, en la cual se reporta la placa, caracteres detectados y reconocidos a fin de evaluar su desempeño.
...
\end{table}
  ...
  En la Tabla \ref{Tab:producion} se observan los resultados obtenidos de las 10 capturas. La tasa de éxito obtenida en la detección de carácter fue de 100\% Por otro lado, la tasa de éxito en el reconocimiento de caracteres es de  93,40\% en reconocimiento de caracteres.
