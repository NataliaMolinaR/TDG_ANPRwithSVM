...
El módulo reconoció en su mayoría  los caracteres de las placas realizando correctamente las extracciones como se puede observar en las Figuras \ref{fig:placaext82db}, \ref{fig:placaext161db} y \ref{fig:placaext229db}. Se observa en la parte superior de las  figuras la placa a la cuál corresponde la extracción.
