...
Se seleccionó esta arquitectura ya que la solución propuesta para la problemática planteada se puede describir en tres diferentes etapas, cuyas  funcionalidades son independientes entre sí, pudiéndose  definir las interacciones entre las entradas y salidas. En la figura \ref{fig:segmentacion1} se puede observar un esquema general del proyecto expresada en módulos.
...
El módulo de segmentación (Ver listado xxx en el Anexo) se encarga de detectar y extraer los caracteres de interés dentro de la placa. Esto se realizó mediante técnicas de procesamiento de imágenes mediante la librería la librería OpenCV. Se describe  dicho proceso en el siguiente diagrama de flujo:
